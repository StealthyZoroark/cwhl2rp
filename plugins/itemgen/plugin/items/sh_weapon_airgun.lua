...
ITEM.model = "models/weapons/w_airgun.mdl";
ITEM.weight = 4;
ITEM.uniqueID = "star_airgun";
ITEM.business = false;
ITEM.description = "The airgun is a pneumatic weapon that propels 9x18 rounds by means of compressed air."
