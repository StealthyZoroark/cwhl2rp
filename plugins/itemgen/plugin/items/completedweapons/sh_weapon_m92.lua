...
local ITEM = Clockwork.item:New("weapon_base");
 ...
 ITEM.name = "M-92";
ITEM.cost = 100;
ITEM.model = "models/weapons/w_m92.mdl";
ITEM.weight = 2;
ITEM.uniqueID = "star_m92";
ITEM.category = "Pistols";
ITEM.business = true;
ITEM.description = "A Itlian pistol designed and manufactured by Beretta, it is loaded with 9x19 rounds.";
