...
ITEM.weight = 5;
ITEM.uniqueID = "srp_ak74su";
ITEM.business = false;
ITEM.description = "A Soviet submachine gun and assault rifle hybrid, with a shorter barrel and more compact stock, this weapon was used for close quarters combat. It is loaded with 5.45 ammo."
