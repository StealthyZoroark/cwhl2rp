...
ITEM.weight = 3;
ITEM.uniqueID = "srp_uzi";
ITEM.business = false;
ITEM.description = "A Israeli open-bolt, blowback-operated submachine gun, used by special forces and as a personal defence weapon. It is loaded with 9x19 rounds."
