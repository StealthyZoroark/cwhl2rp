...
ITEM.model = "models/weapons/w_fnfal.mdl";
ITEM.weight = 6;
ITEM.uniqueID = "srp_fnfal";
ITEM.business = false;
ITEM.description = "A Belgium battle riffle used by many NATO countries due to its effectiveness. It is chambered in 7.62 ammunition."
