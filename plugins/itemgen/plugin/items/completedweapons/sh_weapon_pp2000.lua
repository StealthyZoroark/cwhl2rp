...
ITEM.name ="PP-2000";
ITEM.cost = 300;
ITEM.category = "Submachine Gun";
ITEM.model = "models/weapons/w_pp2000.mdl";
ITEM.weight = 3;
ITEM.uniqueID = "srp_pp2000";
ITEM.business = false;
ITEM.description = "A Russian submachine gun made by the KBP Instrument Design Bureau. It was designed as a close-quarter combat weapon, intended for riot and police use, and utilizes 9x19 rounds."
ITEM.isAttachment = true;
  ITEM.hasFlashlight = false;
	...
	ITEM.customFunctions = {"Repair", "Attach/Detach Flashlight"};
	ITEM.isBroken = false
	ITEM.hasFlashlight = false
