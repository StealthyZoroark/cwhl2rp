...
ITEM.weight = 5.5;
ITEM.uniqueID = "star_svt";
ITEM.business = false;
ITEM.description = "A Soviet semi-automatic battle rifle, the SVT-40 saw widespread service during and after World War 2. It is loaded with 7.62 ammunition."
