...
ITEM.model = "models/weapons/w_mosin.mdl";
ITEM.weight = 6;
ITEM.uniqueID = "star_mosin";
ITEM.business = false;
ITEM.description = "A 5 shot, bolt-action, internal magazine-fed military rifle developed by the Imperial Russian Army for use in World War One. Chambered in 7.62 rounds."
