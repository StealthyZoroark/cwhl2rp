...
ITEM.weight = 5.5;
ITEM.uniqueID = "srp_sv10";
ITEM.business = false;
ITEM.description = "A Italian over and under variant of the double barrel shotgun, the SV-10 was mostly used for civilian self defence and sport shooting. It is loaded with 12 gauge rounds."
