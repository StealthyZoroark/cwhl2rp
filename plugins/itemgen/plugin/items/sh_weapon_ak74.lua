...
ITEM.weight = 5.5;
ITEM.uniqueID = "srp_ak74";
ITEM.business = false;
ITEM.description = "A Soviet assault rifle designed in the early 1970s used by Russian infantry against the Mujahadeen in the Soviet-Afghani war. It utilizes 5.45 ammo."
