...
ITEM.model = "models/weapons/w_m1garand.mdl";
ITEM.weight = 6;
ITEM.uniqueID = "star_enfield";
ITEM.business = false;
ITEM.description = "A American semi-automatic rifle used by infantry during World War 1. Chambered in 7.62 rounds."
