...
ITEM.weight = 3.5;
ITEM.uniqueID = "srp_ppsh41";
ITEM.business = false;
ITEM.description = "A Soviet submachine gun designed as a cheap and simple alternative to its older brother, the PPD-40. It was mostly used as a infantry weapon, and utilizes 7.62 ammunition."
