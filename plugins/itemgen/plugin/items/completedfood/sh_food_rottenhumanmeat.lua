...
ITEM.name = "Rotten Human Meat";
ITEM.cost = 20;
ITEM.model = "models/fallout 3/mirelurk_cake.mdl";
ITEM.weight = 0.5;
ITEM.access = "1";
ITEM.useText = "Attempt to eat";
ITEM.business = true;
ITEM.category = "Consumables";
ITEM.defaultQuality = "rubbish";
ITEM.description = "If human meat wasn't bad enough, this has festering pores and is extremely rotten. Don't even think about eating it.";
