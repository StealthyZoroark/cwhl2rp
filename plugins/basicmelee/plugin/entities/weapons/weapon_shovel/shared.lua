...
if (SERVER) then
	...
	Clockwork.kernel:AddFile("models/weapons/v_shovel/v_shovel.dx80.vtx");
	Clockwork.kernel:AddFile("models/weapons/v_shovel/v_shovel.dx90.vtx");
	Clockwork.kernel:AddFile("models/weapons/v_shovel/v_shovel.sw.vtx");
	Clockwork.kernel:AddFile("models/weapons/v_shovel/v_shovel.mdl");
	Clockwork.kernel:AddFile("models/weapons/v_stunstick.phy");
	Clockwork.kernel:AddFile("models/weapons/v_shovel/v_shovel.vvd");
end;
...
SWEP.Purpose = "Kill and bury your enemies in a single tool.";
SWEP.Contact = "";
SWEP.Author	= "Starlox";
