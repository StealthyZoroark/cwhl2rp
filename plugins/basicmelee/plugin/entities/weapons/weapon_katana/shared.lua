...
if (SERVER) then
	...
	Clockwork.kernel:AddFile("models/weapons/v_katana.dx80.vtx");
	Clockwork.kernel:AddFile("models/weapons/v_katana.dx90.vtx");
	Clockwork.kernel:AddFile("models/weapons/v_katanar.sw.vtx");
	Clockwork.kernel:AddFile("models/weapons/v_katana.mdl");
	Clockwork.kernel:AddFile("models/weapons/v_stunstick.phy");
	Clockwork.kernel:AddFile("models/weapons/v_katana.vvd");
end;
...
SWEP.Purpose = "A good slicing weapon, completely ineffective against armor.";
SWEP.Contact = "";
SWEP.Author	= "Starlox";
