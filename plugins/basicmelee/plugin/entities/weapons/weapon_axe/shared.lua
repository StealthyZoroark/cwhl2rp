...
if (SERVER) then
	...
	Clockwork.kernel:AddFile("models/weapons/v_axe/v_axe.dx80.vtx");
	Clockwork.kernel:AddFile("models/weapons/v_axe/v_axe.dx90.vtx");
	Clockwork.kernel:AddFile("models/weapons/v_axe/v_axe.sw.vtx");
	Clockwork.kernel:AddFile("models/weapons/v_axe/v_axe.mdl");
	Clockwork.kernel:AddFile("models/weapons/v_stunstick.phy");
	Clockwork.kernel:AddFile("models/weapons/v_axe/v_axe.vvd");
end;
...
SWEP.Purpose = "A axe with a wooden handle, a decent slashing weapon.";
SWEP.Contact = "";
SWEP.Author	= "Starlox";
