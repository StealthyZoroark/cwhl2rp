...
Clockwork.option:SetKey("default_date", {month = 4, year = 2038, day = 1});
...
Clockwork.option:SetKey("intro_image", "cwmetro2033/metro2033_logo");
Clockwork.option:SetKey("schema_logo", "cwmetro2033/metro2033_logo");
Clockwork.option:SetKey("format_cash", "%a %n");
Clockwork.option:SetKey("menu_music", "avoxgaming/music/armstrong.mp3");
Clockwork.option:SetKey("name_cash", "Military Grade Rounds");
Clockwork.option:SetKey("model_cash", "models/props_lab/box01a.mdl");
Clockwork.option:SetKey("gradient", "halfliferp/dirty");
