...
function PLUGIN:LoadSurfaceZones()
	self.surfaceZones = Clockwork.kernel:RestoreSchemaData( "plugins/surfacezones/"..game.GetMap() );
end;

-- A function to save the area names.
function PLUGIN:SaveSurfaceZones()
	Clockwork.kernel:SaveSchemaData("plugins/surfacezones/"..game.GetMap(), self.surfaceZones);
end;